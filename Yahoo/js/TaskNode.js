...
YAHOO.widget.TaskNode.prototype.getNodeHtml = function() { 
   // this.logger.log("Generating html");
    ...
    for (i=0;i<this.depth;++i) {
        sb[sb.length] = '<td style=\"border:0px;\" class="' + this.getDepthStyle(i) + '">&#160;</td>';
    }

    sb[sb.length] = '<td style=\"border:0px;\" ';
    ...
    /*sb[sb.length] = '<a';
    sb[sb.length] = ' id="' + this.labelElId +"_+"  + '"';
    sb[sb.length] = ' class="' + this.labelStyle + '"';
    sb[sb.length] = ' href="' + this.href1 + '"';
    sb[sb.length] = ' >';
    sb[sb.length] = '+';
    sb[sb.length] = '</a>';
